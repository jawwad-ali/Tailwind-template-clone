      ...
      <div className=" flex flex-wrap relative">
        <div className="w-full ">
          <div className="container mx-auto flex mt-24 ">
            {/* left Col */}
            <div className="w-6/12 md:w-8/12 mt-28 md:mt-5 flex flex-col pt-2 px-4">
            ...
            <img
              ...
              alt=""
              className="absolute top-0 b-auto right-0 pt-16 sm:w-6/12  -pt-56 sm:mt-0 w-10/12 max-h-860px"
            />
          </div>
        </div>
      </div>
